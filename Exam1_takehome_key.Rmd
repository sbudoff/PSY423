...
print(paste0("p=", round(q5$p.value,8)))
...
print(paste0("Mean = ", round(unique(paired_data$x_bar[1],3))))
```
...
```{r q2f}
print(paste0("Mean = ", round(unique(paired_data$x_bar[2],3))))
```
...
print(paste0("Max = ", round(unique(paired_data$max[1]),3)))
```
...
```{r q2h}
print(paste0("Max = ", round(unique(paired_data$max[2]),3)))
```
...
```{r q2g2}
print(paste0("Min = ", round(unique(paired_data$min[1]),3)))
```
...
```{r q2h2}
print(paste0("Min = ", round(unique(paired_data$min[2]),3)))
```
