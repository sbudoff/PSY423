...
## $\alpha = 0.05$
![](/home/sam/Regis/PSY423/QR_Codes/p-value.png){width=700px}
...
Practice saying these hypotheses in words
$$H_0 : \mu_1 = \mu_2$$
$$H_a : \mu_1 \neq \mu_2$$
...
# Define the range where the overlap occurs (between 1 and 3)
overlap_range <- c(low, high)
...
# Desired overlap percentage (e.g., 85%)
desired_overlap_percentage <- 0.8
